...
# Instalar todas las dependencias con legacy-peer-deps para evitar conflictos de React 19
...
# Esto genera la carpeta /dist y transpile server.ts a server.js
RUN npm run build

# --- ETAPA 2: PRODUCCIÓN ---
FROM node:20-alpine AS runner

# Definir metadatos corporativos
