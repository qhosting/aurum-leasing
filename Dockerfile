...
# CRÍTICO: Copiar la carpeta de migraciones consolidada para el bootstrap de la DB
...
# Healthcheck avanzado apuntando a la API de estado
...
# Comando de arranque que dispara el servidor (el cual ejecuta las migraciones internamente)
CMD ["node", "server.js"]
